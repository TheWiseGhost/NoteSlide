    ...
    <div className="min-h-screen bg-white flex flex-col px-4 md:px-20 pt-20 pb-12">
      ...
      <div className="pt-12 text-center">
        <p className="text-neutral-600 text-3xl font-outfit">
          You know everything we can <br className="block" /> do for you
        </p>
      </div>
      <div className="flex flex-row pt-20 mx-auto space-x-8 md:space-x-12 justify-center items-center">
        <div className="flex w-full justify-end">
          <div
            onClick={() => navigate("/auth")}
            className="flex main w-28 md:w-40 py-6 text-xl md:text-2xl"
          >
            <span>Sign Up</span>
          </div>
        </div>
        ...
        <div className="w-full justify-center">
          <p className="w-full md:w-3/5 text-lg md:text-2xl mr-auto font-josefin text-black">
